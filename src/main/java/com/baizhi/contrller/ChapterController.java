...
public class ChapterController {
    ...
    public Map< String, Object > findAllAlbum(Integer page, Integer rows, String albumId) {
        Map< String, Object > allAlbum = chapterServices.findAllChapter(page, rows, albumId);
        return allAlbum;
    }
    ...
    public String edit(Chapter chapter, String oper, String albumId, String[] id) {
        if ("add".equals(oper)) {
            String s = chapterServices.add(chapter);
            return s;
        }
        if ("edit".equals(oper)) {
            System.out.println("controller======");
            chapterServices.update(chapter);
        }
        if ("del".equals(oper)) {
            chapterServices.del(id);
    ...
    public void upload(MultipartFile filepath, String chapterId, String albumId, HttpSession session) throws IOException, TagException, ReadOnlyFileException, CannotReadException, InvalidAudioFrameException {
        ...
        chapterServices.updateFilepath(chapter);
