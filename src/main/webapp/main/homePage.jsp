...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <li><a href="javascript:$('#changeContent').load('echartsMap1.jsp')">用户列表</a></li>
                        </div>
                        <div class="panel-body">
                            <li><a href="javascript:$('#changeContent').load('echarts.jsp')">用户</a></li>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="changeContent" class="col-xs-10">
            <div class="jumbotron"
                 style="background-color:#F9F9F9;padding-top: 19px;padding-bottom: 19px;margin-bottom: -3px">
